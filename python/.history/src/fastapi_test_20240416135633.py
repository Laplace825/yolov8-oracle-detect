...
upload_loader = working_space + "/img"


def use_onnx(
    input_img_det_path, output_det_img_path, input__img_cls_path, output_cls_txt_path
):
    """
...
def use_pt(input_img_det_path, output_det_dir, output_cls_result):
    """
