...
def use_onnx():
    ...
    output_det_img_path = working_space + "/output_text_img_onnx/"

    net_cls_path = working_space + "/best_cls.onnx"
    input__img_cls_path = working_space + "/output_text_img_onnx/"
    class_name_path = working_space + "/class_cls.txt"
    output_cls_txt_path = working_space + "/output_cls.txt"
...
def use_pt():
    ...
    output_det_dir = working_space + "/output_img_pt"
    pt_cls_path = working_space + "/best_cls.pt"
    output_cls_result = working_space + "/output_img_pt/0/cls"
    det.det_yolo(
        pt_det_path,
        input_img_det_path,
        output_det_dir,
