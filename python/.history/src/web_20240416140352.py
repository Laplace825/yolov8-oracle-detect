...
def use_pt(self,input_img_det_path, output_det_dir, output_cls_result):
    """
    ...
    return {*}
    """
    pt_det_path = self.working_space + "/best_det.pt"
    pt_cls_path = self.working_space + "/best_cls.pt"
